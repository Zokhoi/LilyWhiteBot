...
const faces = {
    ...
    240: '喷脸', 241: '生日快乐', 242: '头撞击', 243: '甩头', 244: '扔狗', 245: '加油必胜', 246: '加油抱抱', 247: '口罩护体',
    ...
    290: '敲开心', 291: '震惊', 292: '让我康康', 293: '摸锦鲤', 294: '期待', 295: '拿到红包', 296: '真好', 297: '拜谢', 298: '元宝', 299: '牛啊',
    300: '胖三斤', 301: '好闪', 302: '左拜年', 303: '右拜年', 304: '红包包', 305: '右亲亲', 306: '牛气冲天', 307: '喵喵', 308: '求红包', 309: '谢红包',
    310: '新年烟花', 311: '打call', 312: '变形', 313: '嗑到了', 314: '仔细分析', 315: '加油', 316: '我没事', 317: '菜狗', 318: '崇拜', 319: '比心',
    320: '庆祝', 321: '老色痞', 322: '拒绝', 323: '嫌弃', 324: '吃糖', 325: '惊吓', 326: '生气', 327: '加一', 328: '错号', 329: '对号',
    330: '完成', 331: '明白', 332: '举牌牌', 333: '烟花', 334: '虎虎生威', 335: '绿马护体', 336: '豹富', 337: '花朵脸', 338: '我想开了', 339: '舔屏',
    340: '热化了', 341: '打招呼', 342: '酸Q', 343: '我方了', 344: '大怨种', 345: '红包多多', 346: '你真棒棒', 347: '大展宏兔', 348: '福萝卜', 349: '坚强',
    350: '贴贴', 351: '敲敲', 352: '咦', 353: '拜托', 354: '尊嘟假嘟', 355: '耶', 356: '666', 357: '裂开', 358: '骰子', 359: '包剪锤',
    360: '亲亲', 361: '狗狗笑哭', 362: '好兄弟', 363: '狗狗可怜', 364: '超级赞', 365: '狗狗生气', 366: '芒狗', 367: '狗狗疑问', 368: '奥特笑哭', 369: '彩虹',
    370: '祝贺', 371: '冒泡', 372: '气呼呼', 373: '忙', 374: '波波流泪', 375: '超级鼓掌', 376: '跺脚', 377: '嗨', 378: '企鹅笑哭', 379: '企鹅流泪',
    380: '真棒', 381: '路过', 382: 'emo', 383: '企鹅爱心', 384: '晚安', 385: '太气了', 386: '呜呜呜', 387: '太好笑', 388: '太头疼', 389: '太赞了',
    390: '太头秃', 391: '太沧桑', 392: '龙年快乐', 393: '新年中龙', 394: '新年大龙', 395: '略略略', 396: '狼狗', 397: '抛媚眼', 398: '超级ok', 399: 'tui',
    400: '快乐', 401: '超级转圈', 402: '别说话', 403: '出去玩', 404: '闪亮登场', 405: '好运来', 406: '姐是女王', 407: '我听听', 408: '臭美', 409: '送你花花',
    410: '么么哒', 411: '一起嗨', 412: '开心', 413: '摇起来',
};

/**
 * 取得QQ伺服器上的圖片網址
 * 僅用於使用舊版QQ客戶端/協議所發的圖片
    ...
    if (typeof message === "string") {
        text = message.replace(/\n/gu, '&#10;').replace(/\[CQ:([^,]*?)\]/gu, '[CQ:$1,]').replace(/\[CQ:(.*?)((?:,).*?)\]/gu, (_, type, param) => {
            ...
            switch (type) {
                ...
                case 'flash':
                    // [CQ:flash,file=0792531B8B74FE6F86B87ED6A3058779.png]
                    tmp3 = true;
                case 'image':
                    // [CQ:image,file=0792531B8B74FE6F86B87ED6A3058779.png]
                ...
                case 'sign':
                    // [CQ:sign,title=我过来签个到啦,image=https://p.qpic.cn/qunsign/0/sign_30cc0f793307325b74be99fabd5f9cfcjs0qje77/750]
                    tmp = ['<签到>'];
                    tmp1 = param.match(/(?:^|,)title=(.*?)(?:,|$)/u);
                    if (tmp1 && tmp1[1]) {
                        tmp.push(tmp1[1]);
                ...
                case 'location':
                    // [CQ:location,lat=23.081961,lon=113.453041,title=大吉沙,content=广东省广州市黄埔区,style=1]
                    tmp = ['<位置>'];
                    tmp1 = param.match(/(?:^|,)title=(.*?)(?:,|$)/u);
                    tmp2 = param.match(/(?:^|,)content=(.*?)(?:,|$)/u);
        ...
        for (let i = 0; i < message.length; i++) {
            ...
            switch (curr.type) {
                ...
                case 'mface':
                    text = `<${curr.data.summary}> ${curr.data.url}`;
                    break;
                ...
                case 'json':
                    ...
                    if (tmp.view && tmp.view == 'music') {
                        text = `<分享${tmp.meta[tmp.view].tag}：${tmp.meta[tmp.view].title}> ${tmp.meta[tmp.view].jumpUrl}`;
                    } else if (tmp.view && tmp.view == 'news') {
